import { INodePointer, IElementRect, IJsPath, INodeVisibility } from '@justinearl/js-path';
...
import { isMousePositionXY } from '@justinearl/unblocked-specification/agent/interact/IInteractions';
