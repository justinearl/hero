import type { IDomStorageForOrigin } from '@justinearl/unblocked-specification/agent/browser/IDomStorage';
import type { IIndexedDB } from '@justinearl/unblocked-specification/agent/browser/IIndexedDB';
