...
import { ICorePluginClass } from '@justinearl/hero-interfaces/ICorePlugin';
...
import { LocationTrigger } from '@justinearl/unblocked-specification/agent/browser/Location';
